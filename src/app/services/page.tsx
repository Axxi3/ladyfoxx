...
export default function page() {
  return (
    <div className='flex flex-col bg-[#134441] items-center justify-center  mt-42'>
         <div className="md:mt-8 mt-20  flex max-w-6xl items-center flex-col justify-center ">
                ...
                <TextAnimate
                  ...
                  by="character"
                  once
                  className="lg:text-[60px] max-w-4xl text-center md:text-[60px] text-[38px]  text-white mb-1"
                >
